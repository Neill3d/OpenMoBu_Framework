...
namespace OpenMoBuUnitTests
{
	...
	*/
    ...
    class MyShaderMOC : public NOpenMobu::CShader<MyShaderMOC>
	{
	private:
	...
	public:
		...
		bool LoadShaders(
                    ...
                    const NOpenMobu::CFileBase& fragment_file) override
		{
			bool status = true;
        ...
        bool LoadShaders(
                    const MyShaderMOC& referenceShader,
                    const NOpenMobu::CFileBase& fragment_file) override
		{
			return false;
		}
		...
		MyShaderMOC& Bind() const override
		{}
        MyShaderMOC& UnBind() const override
		{}
		...
		MyShaderMOC& SetUniformUINT(const int location,
                                           const int value) override {}
                MyShaderMOC& SetUniformFloat(const int location,
                                             const float value) override {}
                MyShaderMOC& SetUniformVector(const int location,
                                              const float x,
                                              const float y,
                                              const float z,
                                              const float w) override {}
                MyShaderMOC& SetUniformVector4(const int location,
                                               const float* arr) override {}
                MyShaderMOC& SetUniformVector2f(const int location,
                                                const float x,
                                                const float y) override {}
                MyShaderMOC& SetUniformMatrix33(const int location,
                                                const float* m) override {}
                MyShaderMOC& SetUniformMatrix(const int location,
                                              const float* m) override {}

		MyShaderMOC& BindTexture(unsigned int target,
                                         const char* texname,
                                         unsigned int texid,
                                         int texunit) override {}
                MyShaderMOC& BindTexture(unsigned int target,
                                         const int location,
                                         unsigned int texid,
                                         int texunit) override {}
                MyShaderMOC& UnBindTexture(unsigned int target,
                                           int texunit) override {}
                MyShaderMOC& BindTextureRECT(const char* texname,
                                             unsigned int texid,
                                             int texunit) override {}
	};
	...
	public:
		...
		static CShaderBase* CreateMyShader(ShaderType shaderType) { return new MyShaderMOC(); }
		...
		TEST_METHOD(TestShaderLoad)
		{
			...
			CShaderFactory::RegisterShaderType(ShaderType::GLSL, CreateMyShader);
